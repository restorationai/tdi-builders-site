---
archetype: "blog-post"
title: "Storm Damage Insurance Claim Checklist for Homeowners"
h1: "Storm Damage Insurance Claim Checklist for Homeowners"
meta_description: ""
primary_keyword: "storm damage insurance claim checklist for homeowners"
secondary_keywords: ["storm damage restoration"]
search_intent: "informational_insurance"
priority: 4.8
plan_hash: "d879ae3dd0b2b46a"
generated_at: "2026-08-24T08:29:53.283823+00:00"
manual_override: false
internal_links: ["/blog/", "/services/storm-damage-restoration/", "/blog/storm-damage-repair-process/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Blog", "url": "/blog/"}, {"name": "Storm Damage Insurance Claim Checklist for Homeowners"}]
faq: [{"question": "How long do I have to file a storm damage insurance claim in California?", "answer": "California does not set a single statutory deadline for filing a property damage claim, but your individual policy will specify a reporting window \u2014 commonly one year from the date of loss, though some policies are shorter. The more important practical deadline is the insurer's obligation to respond: once you report, they must acknowledge within 15 days and resolve within 40 days of receiving your proof of loss. Report as soon as it is safe to do so, because delay can give the insurer grounds to argue that damage worsened due to your inaction."}, {"question": "Can I get my own contractor estimate before the insurance adjuster visits?", "answer": "Yes, and it is often a good idea. California does not require you to use the insurer's preferred contractor network, and you are free to solicit independent estimates at any time. Having your own written estimate before the adjuster's visit gives you a benchmark to compare against their scope of loss. If the adjuster's estimate is significantly lower, a detailed contractor estimate is one of the strongest tools for requesting a re-inspection or supplemental payment."}, {"question": "What if the adjuster says the damage was pre-existing and not caused by the storm?", "answer": "Pre-existing condition denials are common and not always accurate. Your best counter-evidence is pre-storm documentation \u2014 prior inspection reports, real estate listing photos, or even dated personal photos showing the roof or siding in good condition before the event. A licensed contractor's written assessment explaining why the damage pattern is consistent with wind or impact rather than age-related deterioration can also support your position. If the denial stands, most policies include an appraisal clause that allows both parties to hire independent appraisers to resolve the dispute without going to court."}, {"question": "My roof looks fine from the ground but I think there might be interior water damage. Should I wait for the adjuster?", "answer": "Don't wait on the water. If you have reason to believe water entered the structure \u2014 ceiling stains, musty odor, soft spots in flooring \u2014 you should have the interior assessed promptly. Mold can begin growing on wet framing and insulation within 24 to 48 hours under the right temperature conditions. Document the interior damage thoroughly with photos and video before any drying work begins, and save any materials that are removed. The adjuster can review your documentation and the contractor's moisture readings even if they haven't visited yet; a well-documented scope of drying work is fully claimable."}]
...
This is the single most important rule of storm damage claims: **photograph and video the damage in its original state before any cleanup or temporary repairs begin.** Adjusters are trained to look for evidence that damage pre-existed the storm or was worsened by delayed action. Your documentation is your defense.
